...
var keyvars = {
  inbentakeyvar: "BY3wM1tPeCr8YG3pQ/sp6hhYL8qSvVTHmD7BHOdU4gk=",
  domainkeyvar:
    "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJwcm9qZWN0IjoiYWxwaGFudW1lcmljX3NzX2NoYXRib3RfZW4iLCJkb21haW5fa2V5X2lkIjoiQmo2SDRpSjlISmJkTzF0NEcxWTlFQTo6In0.pgydE9xqRXflZdr67Jjbp5X0ywva-Q-vdd0HnbW-WZSJZL1jWsWlPnl5yyj5kTne2PCQYS0ATfBwhx1XGpAEhA",
};
...
var inbChatbotApp = {
  sdkChatbotIntegration: {
    ...
    version: "1.72.0",
    integrity:
      "sha384-HlSG7tD87XsgPLEqQ/y0pomXhrEH32bVQQ4HopRNHYF2fBPfBTrJFCJkdeSeWhKk",
  },
  sdkChatbotAuth: {
    inbentaKey: keyvars.inbentakeyvar,
    domainKey: keyvars.domainkeyvar,
  },
  sdkChatbotConfig: {
    chatbotId: "alphanumeric_ss_chatbot_en",
    ...
    labels: {
      en: {
        "escalate-chat":
          "Do you want to start a chat with a Live Chat Specialist?",
        "custom-user-type-question":
...
(function (global, factory) {
  ...
  function importScript(script, callback) {
    ...
    if (typeof script === "object") {
      ...
      throw new Error(
        "Helper - importScript: script argument passed is not valid"
      );
    }
    document
      .getElementsByTagName("head")[0]
      .appendChild(dom, document.currentScript);
  }
  ...
  StorageManager.prototype.remove = function remove(index) {
    var data = this.get();
    delete data[index];
    localStorage.setItem(this.DATA_INDEX, JSON.stringify(data));
  };
  ...
  appChatbot.sdkChatbotConfig.adapters =
    typeof appChatbot.sdkChatbotConfig.adapters !== "undefined"
      ? appChatbot.sdkChatbotConfig.adapters
      : [];
  ...
  var userType =
    params.userType && params.userType !== "null" && params.userType !== "none"
      ? params.userType
      : undefined;
  var product =
    params.product && params.product !== "null" && params.product !== "none"
      ? params.product
      : undefined;

  if (typeof storage.get("userType") === "undefined") {
    storage.set("userType", userType);
  }
  if (typeof storage.get("product") === "undefined") {
  ...
  importScript(sdkChatbotScript, function () {
    appChatbot.sdkChatbotConfig.adapters.push(
      SDKInbentaChatbotSurveyAdapter(1)
    );
    window.InbentaChatbotSDK.buildWithDomainCredentials(
      appChatbot.sdkChatbotAuth,
      appChatbot.sdkChatbotConfig
    );
  });
});
