    ...
    const initializeSearch = () => {
      if (window.InbentaSearchSDK) {
        try {
          ...
          // Create Generative AI component
          const generativeAi = sdk.component('generative-ai-response', generativeAiRef.current, {
            enable: true,
            consent: {
              enable: true,
              title: 'AI-Generated Response Consent',
              body: 'Do you accept the use of Generative AI to generate responses to your questions? <a href="https://inbenta.com/privacy" target="_blank">Click here for more information</a>.',
              acceptButton: 'Accept',
              declineButton: 'Decline',
              links: [
                {
                  text: "Privacy Policy",
                  url: "https://inbenta.com/privacy"
                }
              ]
            },
            disclaimer: {
              body: 'This answer was generated by AI based on available documentation'
            },
            errors: {
              notResponse: 'Sorry, I don\'t have an AI-generated response for your query.'
            },
            charsPerChunk: 3,
            delayOnChunk: 50,
            context: {
    ...
    <Card className="w-full">
      <CardHeader>
        ...
        <p className="text-muted-foreground text-sm">
          Search through documentation, answers, and articles for your questions
        </p>
      </CardHeader>
      <CardContent className="space-y-6 pt-0 px-4 pb-4 w-full">
        ...
        <div className="mb-6">
          <div 
            ref={generativeAiRef}
            className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4"
          />
        </div>
